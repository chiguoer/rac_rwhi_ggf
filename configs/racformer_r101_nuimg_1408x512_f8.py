...
total_epochs = 24  # 根据表格修改为24个epoch
batch_size = 4  # 可能需要根据GPU内存调整

# 需要更改为ResNet101的预训练权重
